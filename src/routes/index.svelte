...
<div class="max-w-2xl mx-auto p-4 sm:p-8">
  ...
  >
    <div class="order-1 sm:order-0 text-sm sm:text-base">
      <div>
        <p class="mb-2">
          Ég er vörustjóri hjá <a
            class="font-bold"
            href="https://www.getsling.com">Sling</a
          >
          og vinn að nýrri vöru þar sem heitir
          <a
            class="font-bold"
          ...
          <a class="font-bold" href="https://www.island.is/">Stafrænt Ísland</a
          >. Ég er stofnandi
          <a class="font-bold" href="https://www.planitor.io/">Planitor</a> og
          <a class="font-bold" href="https://takumi.com/"
            >Takumi International ltd</a
          >. Þar á undan starfaði ég sem forritari og vörustjóri hjá
          <a class="font-bold" href="https://quizup.com">QuizUp</a>.
        </p>
        <p>
          Ég hélt úti fréttabréfinu <a
            class="font-bold"
            href="https://jokull.substack.com/">Reykjavík Mobility</a
          > þar sem fjallað er um samgöngur og skipulag í Reykjavík.
        </p>
      </div>
    </div>
    <div
      class="order-0 sm:order-1 mb-12 sm:mb-0 sm:ml-6 sm:flex-none text-center"
    >
      <img
        alt="Profile bust"
        src="/profile.png"
        class="rounded-full w-48 h-48 bg-lime "
      />
    </div>
  </div>
  <div>
    <Grouper items={posts} groupForItem={getYearFromPost} let:group let:item>
      ...
      <div slot="item">
        ...
        >
          <div class="title font-medium text-xl font-Outfit mb-1">
            {item.title}
          </div>
